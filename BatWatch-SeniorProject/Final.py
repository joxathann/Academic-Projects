...
# Setup code written by Juan Melo
...
#twilio credentials twilio code by Johnathan Gonzalez
...
#code written by Johnathan Gonzalez
root = Tk()
...
#gui coding - by Johnathan Gonzalez
...
# Functions primarily written by juan, edited and merged with gui by Johnathan Gonzalez
def openSwitch(port):
...
#database interaction written by Panatda Wiangngoen edited by Johnathan Gonzalez
...
#scanner functionality, Written first by Juan, edited for functionality by Johnathan Gonzalez
def adminOpen():
...
#more database interaction by Panatda Wiangngoen, Edited to work by Johnathan Gonzalez    
def add_emp(): 
...
#rest of the GUI code written by Johnathan Gonzalez
